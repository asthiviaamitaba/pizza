...
class DatabaseHelper(var context: Context): SQLiteOpenHelper (
    ...
    private val INSERT_ACCOUNT_TABLE = ("INSERT INTO " + TABLE_ACCOUNT + " VALUES ('asthiviaoktandaamitaba@students.amikom.ac.id','Asthivia Oktanda Amitaba','Cashier','amikom')")
